...
void Level::ShowCountdown() {
    Texture2D count3 = game->GetTextureManager().LoadSpecificTexture("count3.png");
    Texture2D count2 = game->GetTextureManager().LoadSpecificTexture("count2.png");
    Texture2D count1 = game->GetTextureManager().LoadSpecificTexture("count1.png");
    Texture2D go = game->GetTextureManager().LoadSpecificTexture("countGO.png");
...
void Level::ShowLevelIntro(int levelNum) {
    const char* fileName = TextFormat("level%d.png", levelNum);
...
void Level::ShowProceedScreen() {
    Texture2D proceed1 = game->GetTextureManager().LoadSpecificTexture("proceed1.png");
    Texture2D proceed2 = game->GetTextureManager().LoadSpecificTexture("proceed2.png");
    Texture2D proceed3 = game->GetTextureManager().LoadSpecificTexture("proceed3.png");
...
void Level::ShowWinScreen() {
    Texture2D win1 = game->GetTextureManager().LoadSpecificTexture("win1.png");
    Texture2D win2 = game->GetTextureManager().LoadSpecificTexture("win2.png");
...
void Level::ShowLoadingScreen(Music music) {
    ...
    Texture2D load25 = game->GetTextureManager().LoadSpecificTexture("load25.png");
    Texture2D load50 = game->GetTextureManager().LoadSpecificTexture("load50.png");
    Texture2D load75 = game->GetTextureManager().LoadSpecificTexture("load75.png");
    Texture2D load100 = game->GetTextureManager().LoadSpecificTexture("load100.png");
    Texture2D enter1 = game->GetTextureManager().LoadSpecificTexture("enter1.png");
    Texture2D enter2 = game->GetTextureManager().LoadSpecificTexture("enter2.png");
...
void Level::ShowControlScreen(Music music) {
    Texture2D control = game->GetTextureManager().LoadSpecificTexture("control.png");
    int centerX = game->GetScreenWidth() / 2;
    int centerY = game->GetScreenHeight() / 2;
